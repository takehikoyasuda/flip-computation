...
the canonical class the \texttt{WeilDivisors} package returns; under the
...
bundled packages \texttt{WeilDivisors}, \texttt{SymbolicPowers},
...
\item
  \textbf{Schwede, K., Smith, Z. et al.} The \texttt{WeilDivisors} package
