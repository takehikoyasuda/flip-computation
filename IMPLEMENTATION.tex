...
with 1.24.05 and 1.24.11, using the bundled packages \texttt{Divisor},
\texttt{SymbolicPowers}, \texttt{Polyhedra}, \texttt{IntegralClosure},
\texttt{MinimalPrimes} and \texttt{Elimination}. \texttt{Divisor} has
since been renamed \texttt{WeilDivisors} and loading it under the old
name now warns; the code has not yet been moved over. From the
repository root:
